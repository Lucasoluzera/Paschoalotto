...
/**
 * Data source for the IngressosConsultar2 view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class IngressosConsultar2DataSource extends DataSource<Ingresso> {
  data: Ingresso[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: Ingresso[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Ingresso[]) {
